...
module.exports = Resource = function () {
    ...
    this.db.run("CREATE TABLE IF NOT EXISTS user (account TEXT UNIQUE NOT NULL, role TEXT NOT NULL)");
    ...
    //TODO: race condition!!! and exclude empty config.master
    // add config.master into db
